/*! AI MCQs JSON Tool — application (library build).
 *  Auto-loaded by mcqs.js AFTER the markup is injected and all third-party
 *  libraries (Tailwind, JSZip, Lucide, KaTeX, PDF.js, Cropper) are present.
 *  Loaded as a normal <script> so its top-level functions stay global —
 *  the inline on* handlers in the markup depend on that.
 */
// ---- Lucide safety guard ----
